...
?>
        ...
        <div class="headwords">
          <div class="row01 tooltip" data-tooltips="300m 상공 무동력 글라이더 뒷좌석에서. Im Wittstock Jul.2019">
            <img src="img/fliegen.png">
          </div>
          <div class="row02">
            <a href="index.php">  <p>
            중력에 갇히거나 벗어나려는 인간, <br>그 실존의 역사를 추적하는 <br> 독립학자 최종덕의 현대자연철학</p></a>
        ...
        <div class="navbar_under">
          <div class="menu_under tooltip" data-tooltips="기존philonatu.com, eyeofphilosophy.net DB를 이전해올 예정입니다.">
            <a style="padding-left:15px" href="archive.php">아카이브(전체목록)</a>
          </div>
          <div class="menu_under">
            <a href="book.php">저서 </a>
          </div>
          <div class="menu_under tooltip" data-tooltips="이 페이지는 서평/책과 최신 연구논문을 소개합니다.">
            <a href="review.php">서평/책/최신논문 소개</a>
          </div>
